...
public class UseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_TYPE.ITEM1.ordinal()) {
            return new Item1ViewHolder(myLayoutinflater.inflate(R.layout.item1_use, parent, false));
        }
        //itme2
        else if (viewType == ITEM_TYPE.ITEM2.ordinal()) {
            return new Item2ViewHolder(myLayoutinflater.inflate(R.layout.item2_use,  parent, false));
        }
        //itme3
        else if (viewType == ITEM_TYPE.ITEM3.ordinal()) {
            return new Item3ViewHolder(myLayoutinflater.inflate(R.layout.item3_use,  parent, false));
        }
        //itme4
        else if (viewType == ITEM_TYPE.ITEM4.ordinal()) {
            return new Item4ViewHolder(myLayoutinflater.inflate(R.layout.item4_use,  parent, false ));
        }
       return null;
