...
public class Overduedapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Overduedapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_TYPE.ITEM1.ordinal()) {
            return new Item1ViewHolder(myLayoutinflater.inflate(R.layout.item1_overdued, parent, false));
        }
        //itme2
        else if (viewType == ITEM_TYPE.ITEM2.ordinal()) {
            return new Item2ViewHolder(myLayoutinflater.inflate(R.layout.item2_overdued,  parent, false));
        }
        //itme3
        else if (viewType == ITEM_TYPE.ITEM3.ordinal()) {
            return new Item3ViewHolder(myLayoutinflater.inflate(R.layout.item3_overdued,  parent, false));
        }
        //itme4
        else if (viewType == ITEM_TYPE.ITEM4.ordinal()) {
            return new Item4ViewHolder(myLayoutinflater.inflate(R.layout.item4_overdued,  parent, false ));
        }
       return null;
